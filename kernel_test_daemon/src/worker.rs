...
fn main() {
    let re = Regex::new(r"http.*gz?").unwrap();
    let text = r#"
    ...
    Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
        by smtp.lore.kernel.org (Postfix) with ESMTP id 19FFEC433B4
        for <stable@archiver.kernel.org>; Mon,  5 Apr 2021 09:07:47 +0000 (UTC)
    Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
        by mail.kernel.org (Postfix) with ESMTP id EDC6E613AC
        for <stable@archiver.kernel.org>; Mon,  5 Apr 2021 09:07:46 +0000 (UTC)
    Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
            id S238466AbhDEJHv (ORCPT <rfc822;stable@archiver.kernel.org>);
    ...
    Archived-At: <https://lore.kernel.org/stable/20210405085031.040238881@linuxfoundation.org/>
